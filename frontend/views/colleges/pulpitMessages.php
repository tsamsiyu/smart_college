...
<script type="text/javascript">
    ...
    function drawChart() {
        ...
        var options = {
            title: 'Распределенность количества отправленных сообщений по кафедрам групп'
        };
        ...
        options = {
            title: 'Распределенность количества отправленных сообщений по факультетам групп'
        };
