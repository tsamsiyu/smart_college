...
<script type="text/javascript">
    ...
    function drawChart() {
        ...
        var options = {
            title: 'Распределенность количества добавленных публичных новостей по кафедрам групп'
        };
        ...
        options = {
            title: 'Распределенность количества добавленынх публичных новостей по факультетам групп'
        };
