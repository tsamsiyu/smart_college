...
<script type="text/javascript">
    ...
    function drawChart() {
        ...
        var options = {
            title: 'График распределенности по кафедрам всех отправленных преподавателями публичных новостей'
        };
        ...
        options = {
            title: 'График распределенности по факультетам всех отправленных преподавателями публичных новостей'
        };
