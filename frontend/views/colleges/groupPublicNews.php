...
<script type="text/javascript">
    ...
    function drawChart() {
        ...
        var options = {
            title: 'График распределенности по кафедрам всех добавленных студентами публичных новостей'
        };
        ...
        options = {
            title: 'График распределенности по факультетам всех добавленных студентами публичных новостей'
        };
